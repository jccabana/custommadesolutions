...
<body>
	<div id="links">
	<a href="http://napoveda.seznam.cz/cz/login/prihlaseni/">Nápov&#283;da</a> | <a href="http://www.seznam.cz" title="Seznam.cz">Seznam</a>
</div>
	...
	<input type="hidden" name="returnURL" value="http://email.seznam.cz/" />
		...
		<p>
			<input type="password" id="password" name="password" placeholder="Heslo" tabindex="2" /><input type="submit" id="submit" name="login" value="P&#345;ihlásit se" tabindex="4" />
		</p>

		<p class="remember">
			<label><input type="checkbox" name="remember" id="remember" value="1" />Pamatovat si m&#283; na tomto po&#269;íta&#269;i</label> (<a href="http://napoveda.seznam.cz/cz/login/prihlaseni/">nápov&#283;da</a>)
		</p>
...
<p>Nejste zaregistrováni na Seznam.cz? <a href="http://registrace.seznam.cz/?coid=&amp;serviceId=email&amp;returnURL=http%3A//email.seznam.cz/">Registrujte se!</a><br/>
<a href="http://napoveda.seznam.cz/cz/zapomenute-heslo.html">Zaslat zapomenuté heslo</a></p>
